...
RAILS_ENV=production THEME_NAME=$1 bundle exec rake assets:precompile > /cloud9/logs/$1.log

# COPY PRECOMPILED ASSETS TO /cloud9/sync/precompiled_assets
cp -R /cloud9/precompiled_assets/$1 /cloud9/sync/precompiled_assets/$2/$1

# COPY LIQUID FILES TO /cloud9/sync/themes/staging OR /cloud9/sync/themes/production
cp -R /cloud9/cloud9/$1 /cloud9/sync/themes/$2/$1
