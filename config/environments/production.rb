OliverPrecompiler::Application.configure do
  ...
  config.assets.precompile += %w[*.png *.jpg *.jpeg *.gif *.svg *.ashx *.cur *.eot *.ttf *.woff *.woff2 stylesheets/application_amp.css stylesheets/application_*.css javascripts/application_*.js]
